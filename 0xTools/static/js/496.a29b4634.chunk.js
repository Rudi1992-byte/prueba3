"use strict";(self.webpackChunk_0xTools=self.webpackChunk_0xTools||[]).push([[496],{9496:(e,t,o)=>{o.r(t),o.d(t,{W3mModal:()=>c});var a=o(1483),i=o(4308),r=o(7022),s=o(6370);const n=r.AH`
  :host {
...
`;o(4815);var l=function(e,t,o,a){var i,r=arguments.length,s=r<3?t:null===a?a=Object.getOwnPropertyDescriptor(t,o):a;if("object"===typeof Reflect&&"function"===typeof Reflect.decorate)s=Reflect.decorate(e,t,o,a);else for(var n=e.length-1;n>=0;n--)(i=e[n])&&(s=(r<3?i(s):r>3?i(t,o,s):i(t,o))||s);return r>3&&s&&Object.defineProperty(t,o,s),s};const d="scroll-lock";let c=class extends r.WF{constructor(){super(),this.unsubscribe=[],this.abortController=void 0,this.open=a.W3.state.open,this.caipAddress=a.WB.state.activeCaipAddress,this.caipNetwork=a.WB.state.activeCaipNetwork,this.shake=a.W3.state.shake,this.initializeTheming(),a.Np.prefetch(),this.unsubscribe.push(a.W3.subscribeKey("open",(e=>e?this.onOpen():this.onClose())),a.W3.subscribeKey("shake",(e=>this.shake=e)),a.WB.subscribeKey("activeCaipNetwork",(e=>this.onNewNetwork(e))),a.WB.subscribeKey("activeCaipAddress",(e=>this.onNewAddress(e)))),a.En.sendEvent({type:"track",event:"MODAL_LOADED"})}disconnectedCallback(){this.unsubscribe.forEach((e=>e())),this.onRemoveKeyboardListener()}render(){return this.open?r.qy`
